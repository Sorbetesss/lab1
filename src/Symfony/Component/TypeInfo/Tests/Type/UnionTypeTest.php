...
class UnionTypeTest extends TestCase
{
    ...
    public function testComposedTypesSatisfy()
    {
        ...
        $this->assertTrue($type->composedTypesSatisfy(static fn (Type $t): bool => $t instanceof BuiltinType));

        $type = new UnionType(Type::int(), Type::string());
        $this->assertFalse($type->composedTypesSatisfy(static fn (Type $t): bool => $t instanceof ObjectType));
    }
