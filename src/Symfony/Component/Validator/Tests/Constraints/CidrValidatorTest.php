...
class CidrValidatorTest extends ConstraintValidatorTestCase
{
     ...
     */
    public function testOutOfRangeNetmask(string $cidr, ?string $version = null, ?int $min = null, ?int $max = null, ?int $maxExpected = null)
    {
    ...
    {
        return [
            ['10.0.0.0/24', Ip::V4, 10, 20, 20],
            ['10.0.0.0/128', null, null, null, 32],
            ['2001:0DB8:85A3:0000:0000:8A2E:0370:7334/24', Ip::V6, 10, 20, 20],
        ];
    }
