...
class YamlFileLoaderTest extends TestCase
{
    ...
    public function testLoadConstraintWithoutNamedArgumentsSupport()
    {
        ...
        $this->expectDeprecation('Since symfony/validator 7.2: Using constraints not supporting named arguments is deprecated. Try adding the HasNamedArguments attribute to Symfony\Component\Validator\Tests\Mapping\Loader\Fixtures\ConstraintWithoutNamedArguments.');
