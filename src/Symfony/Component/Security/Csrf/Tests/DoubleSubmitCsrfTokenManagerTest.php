...
class DoubleSubmitCsrfTokenManagerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->csrfTokenManager = new DoubleSubmitCsrfTokenManager($this->requestStack, $this->logger);
    }

    public function testInvalidCookieName()
    {
        $this->expectException(\InvalidArgumentException::class);
        new DoubleSubmitCsrfTokenManager($this->requestStack, $this->logger, null, [], DoubleSubmitCsrfTokenManager::CHECK_NO_HEADER, '');
    }

    public function testInvalidCookieNameCharacters()
    {
        $this->expectException(\InvalidArgumentException::class);
        new DoubleSubmitCsrfTokenManager($this->requestStack, $this->logger, null, [], DoubleSubmitCsrfTokenManager::CHECK_NO_HEADER, 'invalid name!');
    }
    ...
    {
        $csrfTokenManager = new DoubleSubmitCsrfTokenManager($this->requestStack, $this->logger, null, [], DoubleSubmitCsrfTokenManager::CHECK_ONLY_HEADER);
    ...
    {
        $csrfTokenManager = new DoubleSubmitCsrfTokenManager($this->requestStack, $this->logger, null, [], $checkHeader);
